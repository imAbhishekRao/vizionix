...
const ExperienceExcellence = () => {
  return (
    <section className="bg-white-100 py-3 md:py-5 xl:py-8">
      <div className="container mx-auto">
        <div className="flex justify-center">
          <div className="w-full md:w-5/6 lg:w-2/3 xl:w-7/12">
            <h2 className="mb-4 text-4xl font-bold text-center">Experience Excellence</h2>
            <p className="text-gray-600 mb-5 text-center text-lg md:text-xl">
              Partner with us for innovative digital marketing and cutting-edge web development solutions that drive success.
            </p>
            <hr className="w-1/2 mx-auto mb-5 xl:mb-9 border-gray-400" />
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/3">
            <div className="border border-gray-400">
              <div className="p-3 md:p-4 xl:p-5 flex justify-center items-center">
