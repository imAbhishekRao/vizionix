...
import YourImage from '../image/marketingtestimonial.gif'; // Import the image here
    ...
    START SCALING NOW
        ...
        <div className="flex justify-center lg:w-1/2 w-full">
          <img
            src={YourImage}
            alt="Your Image"
            className="w-full sm:w-3/4 lg:w-auto max-w-lg rounded-lg shadow-lg"
          />
        </div>
      </main>

      {/* Additional Text Section */}
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6 lg:px-16 lg:pt-8 sm:px-12 text-center sm:pt-8">
        Get converting campaigns that scale and take you past
      </h1>
      <span className="text-3xl text-blue-300 sm:text-4xl lg:text-6xl lg:px-24 font-bold leading-tight mb-6 sm:pt-2 sm:mt-2">
        7 & 8 figures
      </span>
    </div>
  );
